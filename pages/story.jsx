    ...
    <div className='w-full'>
     ...
     <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8'>
      <div className='col-span-4'>
        <p>Project</p>
        <h2>Overview</h2>
        <p>Story Creator is a simple app that allows users to create and post short stories, add contributions to a short story, append contributions to story, if required.</p>
        <a
