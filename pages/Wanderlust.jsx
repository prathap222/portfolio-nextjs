  ...
  return (
    <div className='w-full'>
      <div className='w-screen h-[30vh] lg:h-[40vh] relative'>
       ...
       <Image className='absolute z-1' layout='fill' objectFit='cover' src={WanderlustImg} alt='/'/>
       <div className='absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2'>
         <h2 className='py-2'>Wanderlust</h2>
         <h3> React / Material UI / Node / Express / PostgreSQL / Axios </h3>
       </div>
      </div>
      ...
      <div className='col-span-4 md:col-span-1 shadow-xl shadow-gray-400 rounded-xl p-4'>
        <div className='p-2'>
          ...
          <div className='grid grid-cols-3 md:grid-cols-1'>
            ...
            <p className='text-gray-700 py-2 flex items-center'><RiRadioButtonFill className='pr-1'/>Express</p>
            ...
            <p className='text-gray-700 py-2 flex items-center'><RiRadioButtonFill className='pr-1'/>Google Map API</p>
          </div>
