...
const Main = () => {
  return (
    <div id='home' className='w-full h-screen text-center '>
      <div className='max-w-[1240px] w-full h-[130%] mx-auto p-2  flex justify-center items-center'>
        <div>
          <p className='uppercase text-sm tracking-widest  text-[#eeeef8]'>
            LET&apos;S BUILD SOMETHING TOGETHER
          </p>
          <h2 className='py-4 text-[#eeeef8]'>
          ...
          <div className='flex items-center justify-between max-w-[330px] m-auto py-4'>
            ...
            <a
              ...
              rel='noreferrer'
            >
              <div className='rounded-full bg-[#7B68EE] shadow-lg shadow-gray-400 p-6 cursor-pointer hover:scale-110 ease-in duration-300 animate-pulse'>
                <FaGithub/>
              </div>
            </a>
            <Link href='/#contact'>
